...
mongoose.connect(MONGODB_URI, {
  ...
  .then(() => {
    return Recipe.findOneAndUpdate({"title": {$regex: "Rigatoni alla Genovese"}}, {"duration": 100}, {new: true});
  })
  .then(() => {
    return Recipe.remove({"title": {$regex: "Carrot Cake"}}, {single: true});
  })
  .then(() => {
    console.log('Recipe added to db and changes made.');
